...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton mforward, mbackward, mleftward, mrightward;
    int run2 = 250, run3 = 1, run4 = 238, run5 = 71;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mleftward = (ImageButton) findViewById(R.id.leftward);
        mrightward = (ImageButton) findViewById(R.id.rightward);
        ...
        if (mBTArrayAdapter == null) {
                ...
                public boolean onTouch(View view, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        if(mConnectedThread != null) {//First check to make sure thread created
                            String sample = String.valueOf(run2);
                            mConnectedThread.write(sample);
                        }
                    } else if (event.getAction() == MotionEvent.ACTION_UP) {
                        if(mConnectedThread != null) {//First check to make sure thread created
                            String sample = String.valueOf("f");
                            mConnectedThread.write(sample);
                        }
                    }
                    return false;
            ...
            mbackward.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        if(mConnectedThread != null) {//First check to make sure thread created
                            String sample = String.valueOf(run3);
                            mConnectedThread.write(sample);
                        }
                    } else if (event.getAction() == MotionEvent.ACTION_UP) {
                        if(mConnectedThread != null) {//First check to make sure thread created
            ...
            mleftward.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        if(mConnectedThread != null) {//First check to make sure thread created
                            String sample = String.valueOf(run4);
                            mConnectedThread.write(sample);
                        }
                    } else if (event.getAction() == MotionEvent.ACTION_UP) {
                        if(mConnectedThread != null) {//First check to make sure thread created
            ...
            mrightward.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        if(mConnectedThread != null) {//First check to make sure thread created
                            String sample = String.valueOf(run5);
                            mConnectedThread.write(sample);
                        }
                    } else if (event.getAction() == MotionEvent.ACTION_UP) {
                        if(mConnectedThread != null) {//First check to make sure thread created
